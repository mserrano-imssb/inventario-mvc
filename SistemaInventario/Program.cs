...
var connectionString = builder.Configuration.GetConnectionString("PostgresDatabase") ?? throw new InvalidOperationException("Connection string 'PostgresDatabase' not found.");
