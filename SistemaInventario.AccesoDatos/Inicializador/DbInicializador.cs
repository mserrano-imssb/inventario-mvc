...
namespace SistemaInventario.AccesoDatos.Inicializador
{
    public class DbInicializador : IDbInicializador
    {
        ...
        public void Inicializar()
        {
            ...
            {
                UserName = "mario.serrano@imssbienestar.gob.mx",
                Email = "mario.serrano@imssbienestar.gob.mx",
                EmailConfirmed = true,
                Nombres= "Mario",
                Apellidos = "Serrano"
            ...
            UsuarioAplicacion usuario = _db.UsuarioAplicacion.Where(u => u.UserName == "mario.serrano@imssbienestar.gob.mx").FirstOrDefault();
